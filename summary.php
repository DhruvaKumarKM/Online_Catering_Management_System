			...
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    ...
                    <h3 style="text-align:center">Online Catering Services</h3>
<h4 style="text-align:center">#123  College</h4>
<h4 style="text-align:center">Phone No. : 9738318314</h4>
<h4 style="text-align:center">Gmail :  catering@gmail.com</h4>
<h4 style="text-align:center">Facebook : facebook.com/CateringServices</h4>
<hr>
