		...
		<div id="login" class="animate form">
         ...
         <div id="setting">
                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="registerform">
                       ...
                       <div> Email:<input type="text"  width=200px class="text" name="email" placeholder="Enter Valid Email" required value="<?php if ($error) echo $email; ?>"/>
                        ...
                        <div> Password:<input type="password"  width=200px class="text" name="password" size="37" placeholder="Enter Password" required>
                            <p style="color: #FF0000; font-weight: bold; font-size: 24px"><?php if (isset($password_error)) echo $password_error; ?></p>
                             </div>
                        <div>  Confirm Password:<input type="password" width=200px  class="text" size="37" name="cpassword" placeholder="Enter Confirm Passwords" required>
